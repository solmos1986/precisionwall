                ...
                <div class="ms-panel-body">
                    <form id="from_order" method="post" enctype="multipart/form-data" action="{{ route('store.orden') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="job_name"
                                            name="job_name" placeholder="Job Name" disabled="disabled" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control form-control-sm" id="sub_contractor"
                                            name="sub_contractor" style="width:100%" disabled="disabled" required></select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm datepicker" id="date_order"
                                            name="date_order" placeholder="Date of Work" value="{{ date('m/d/Y') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm datepicker" id="date_work"
                                            name="date_work" placeholder="Date of Work" value="{{ date('m/d/Y') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <table class="table table-sm table-hover thead-light" id="table-material">
                            <thead>
                                <tr>
                                    <th scope="col" width="250">type</th>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="9" class="p-0">
                                        <button class="btn btn-sm btn-block btn-success mt-0 add-material"
                                            disabled="disabled">Add material</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="9" class="p-0">
                                        <button class="btn btn-sm btn-block btn-success mt-0 add-equipo"
                                            disabled="disabled">Add equipment</button>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
...
@push('javascript-form')
    ...
    <script src="{{ asset('js/tipo-orden/new.js') }}"></script>
