...
<body>
                ...
                <tbody>
                    @forelse ($resumen as $task)
                        <tr>
                            ...
                            <td class="desc" width="65%">{{ $task->nombre_tarea }}</td>
                            <td class="center" width="15%">{{ $task->porcentaje }}</td>
                        </tr>
                    @empty
                        <tr>
    ...
    <script>
        ...
        $(document).on('click', '#send_mail', function() {
            ...
            $.ajax({
                type: "POST",
                url: `{{ url('/') }}/daily-report-detail/email/{{ $daily_report_detail->actividad_id }}/client`,
