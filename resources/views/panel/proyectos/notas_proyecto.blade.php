        ...
        <div class="col-md-12">
            ...
            <div class="ms-panel">
                <div class="ms-panel-header ms-panel-custome">
                    <h6 class="pt-1">PROJECT NOTE: {{$proyecto->Nombre}}</h6>
                </div>
...
@push('javascript-form')
    ...
    <script>
        ...
        let proyecto={{$proyecto->Pro_ID}}
    </script>
    {{-- sistema movimientos --}}
    <script src="{{ asset('js/proyecto/notas_proyecto/list.js') }}"></script>
    <script src="{{ asset('js/proyecto/notas_proyecto/input_files.js') }}"></script>
@endpush
