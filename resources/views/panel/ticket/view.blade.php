...
<body>
    <div class="page">
        <header class="clearfix_in">
            ...
            <br><br><br>
            <!--end header css-->
            <h1>Work Ticket #0{{ $ticket->num }}</h1>
            <div id="company" class="clearfix_in">
                <div><span>Ticket Number:</span>0{{ $ticket->num }}</div>
        ...
        <main>
            ...
            <div class="cols">
                <div style="text-align: center;">
                    ...
                    @else
                    <img style="width: 2.5cm" src="{{ asset('signatures/no-signature.jpg') }}" id="img_signature_fore">
                    @endif
                ...
                <div style="text-align: center;">
                    ...
                    @else
                    <img style="width: 2.5cm" src="{{ asset('signatures/no-signature.jpg') }}" id="img_signature_super">
                    @endif
