...
@push('javascript-form')
    ...
    <script src="{{ asset('js/configDailyReport/update.js') }}"></script>
    <script src="{{ asset('js/configDailyReport/delete.js') }}"></script>
@endpush
