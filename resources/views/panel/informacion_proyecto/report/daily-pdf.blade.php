...
<body>
    <div class="clearfix_in">
        <h1>REPORT DAILY {{ $from_date == null ? '--/--/--' : $from_date }} TO
            ...
            @if (count($registro_diario->registro_diario_actividad) > 0)
                <main>
                    <table>
                        <thead>
                            <tr>
                                <th colspan="8" class="desc" style="background: white; padding: 1px;">
                        ...
                        <thead>
                            <tr>
                                <th width="15%" colspan="1" class="desc"
                                    style="background: white; padding: 1px; ">
                                    Area OF Work
                                </th>
                                <th width="25%" colspan="1" class="desc"
                                    style="background: white; padding: 1px; ">
                                    Cost Code/Task
                                </th>
                        ...
                        <tbody>
                            @forelse ($registro_diario->registro_diario_actividad as $registro_diario_actividad)
                                <tr>
                                    ...
                                    <td class="center">
                                        {{ $registro_diario_actividad->cantidad_personas }}
                                    </td>
                                    <td class="center">
                                        {{ number_format($registro_diario_actividad->Horas_Contract_total, 2) }}
                                    </td>
                                    <td class="center">
                                        {{ $registro_diario_actividad->porcentaje }}
                                    </td>
                                    <td class="desc">
                                        {{ $registro_diario_actividad->note }}
                                    </td>
                                    <td class="center">
                                        {{ number_format($registro_diario_actividad->Horas_Estimadas, 2) }}
                                    </td>
                                    <td class="center">
                                        {{ number_format($registro_diario_actividad->total_used->Horas_Contract, 2) }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td class="desc" colspan="8" style="text-align: center;">
                                        no records
                                    </td>
                                </tr>
                            @endforelse
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th colspan="1" class="center"
                                    style="background: white; padding: 1px; text-align: center;">
