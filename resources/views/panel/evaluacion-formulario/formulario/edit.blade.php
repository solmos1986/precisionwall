...
<div class="row">
    <div class="col-md-12">
        ...
        <div id="contenedor" class="row justify-content-md-center">
                    ...
                    <div class="ms-panel-body">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <input id="description" type="text" class="form-control" aria-label="Sizing example input"
                                ...
                                value="{{$res_formulario->descripcion}}">
                        </div>
            ...
            @foreach ($res_formulario->secciones as $secciones) 
            ...
            <div class="col-md-10 question">
                <div class="ms-panel">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="text" class="form-control descripcion"
                                        ...
                                        placeholder="SUBTITLE" value="{{ $secciones->subtitulo}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="ms-panel-body">
                     ...
                     @foreach ( $secciones->preguntas as $preguntas)  
