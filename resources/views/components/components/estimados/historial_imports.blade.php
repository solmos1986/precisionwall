<div id="modalHistorialImport" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header color-modal">
                <h5 class="modal-title">Imports saves</h5>
                    ...
                    <div class="ms-panel" style="margin-bottom: 10px;">
                        <div class="ms-panel-body p-2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover  w-100" id="datatable_historial">
                                    <thead>
                                        <tr>
                                            <th scope="col"></th>
