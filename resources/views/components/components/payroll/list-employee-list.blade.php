<div id="lista_importacion_list_employee" class="modal fade" tabindex="-1" role="dialog"
                    ...
                    <div class="ms-panel" style="margin-bottom: 10px;">
                        <div class="ms-panel-body p-2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover w-100" id="datatable_list_employee">
                                    <thead>
                                        <tr>
