$(document).on('click', '.store_nota', function () {
    ...
    var note = $('#note').val();
    var proyecto_manager_id = $('#proyecto_manager_id').is(':checked') == true ? $('#proyecto_manager_id').val() : 0;
    var asistente_proyecto_manager_id = $('#asistente_proyecto_manager_id').is(':checked') == true ? $('#asistente_proyecto_manager_id').val() : 0;
    var foreman_id = $('#foreman_id').is(':checked') == true ? $('#foreman_id').val() : 0;
    var lead_id = $('#lead_id').is(':checked') == true ? $('#lead_id').val() : 0;
    ...
    data.append('foreman', foreman_id);
    data.append('lead', lead_id);
    $.ajax({
        type: 'POST',
...
function limpiar_campos_Text() {
    $('#proyecto_manager').text("");
    $('#asistente_proyecto_manager').text("");
    $('#foreman').text("");
    $('#lead').text("");
