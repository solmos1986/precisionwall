...
$("#buscar").click(function () {
    ...
    dataTable.ajax.url(
        `${base_url}/goal-reports/datatable?multiselect_project=${$('#multiselect_project').val()}&status=${$('#status').val()}&from_date=${$('#from_date').val()}&to_date=${$('#to_date').val()}&cargo=${$('#cargo').val()}&filtro=${$('#filtro').val()}`
    ).load();
});
/*limpiar */
